...
const decisions = {
	colors: {
		...
		primaryInverted: choices.colors.base.white,
		...
		tertiaryMuted: choices.colors.green[500],
		tertiaryInverted: choices.colors.base.white,
	},
	backgroundColor: {
		primary: choices.colors.brand.hintOfRed,
		primaryHighlight: choices.colors.brand.romance,
	},
	container: {
		maxWidth: '800px',
	},
	...
	input: {
		height: '38px',
		maxWidth: '400px',
		background: choices.colors.base.white,
		borderRadius: choices.borderRadius.lg,
		fontSize: choices.fontSize.sm,
	},
	picture: {
		border: `${choices.borderWidth.thin} solid ${choices.colors.brand.regentGray}`,
	},
	card: {
